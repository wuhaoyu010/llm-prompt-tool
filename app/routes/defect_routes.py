...
from ..database import db, Defect, DefectVersion, TestCase, Trueno3Config
from ..services.ssh_service import update_trueno3_defect_definitions
...
def get_defect_details(defect_id):
    """获取缺陷详情"""
    from ..services.image_service import create_preview_image
    from flask import current_app
